...
#For the functions outside of the main game I am using text boxes and then mouse clicks to activate and chnage diffrent parts of the main game
...
WHITE = (255,255,255)
BLACK = (0,0,0)
randclr1=[(207,206,192),(163,163,161),(205,205,205)]
randclr2=[(56, 112, 80),(8, 88, 72),(16, 64, 40),(168, 200, 208)]
randclr3=[(74, 39, 98),(63, 79, 80),(215, 214, 238),(79, 180, 251)]
global randclr
#RPG colors 
clr1 = (48, 52, 109)
clr2 = (78, 74, 78)
...
#https://www.artstation.com/artwork/ddBBe
...
class playermodel(pygame.sprite.Sprite):
    ...
    def update2(self):
        ...
        if hits:
                print(Name)
                print(score)
                file=open("Fgamev2\scoref.txt","a")
...
class platform(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf.fill((random.choice(randclr1)))
...
def timecheck(timeday):
    ...
    SCREEN.fill(WHITE)
    rect0=pygame.Rect(middle_pos-300,300,920,Hbox*2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if rect6.collidepoint((mx,my)):
                    ...
                    sys.exit()
        pygame.display.update()  
def maingame(PLAT,PLR,FIN,Bacisent,platforms,finlineg):
    testgame = True
    while testgame:
        SCREEN.blit(image_time,(0,-50))
        message = "Which option do you chose?"
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if rect4.collidepoint((mx,my)):
                    ...
                    break
def Leaderboard():
    #I will open the leaderboard file right here, then call top 3 and sort them and define them
    TOPSCORES=[]
    file = open("Fgamev2\scoref.txt","r")
    ...
    while test:
        ...
        text2 = TitleFont.render("scores start at 10", 1, BLACK)
        ...
        SCREEN.blit(text, (first_pos+60,rect1.y+60))
        #2nd
        rect2=pygame.Rect(middle_pos, 350, Wbox*2,Hbox*2)
        ...
        pygame.draw.rect(SCREEN, BLACK, rect3, width=10)
        text = TitleFont.render("1."+"_"+TOPSCORES[3], 1, BLACK)
        SCREEN.blit(text, (last_pos+60,rect2.y+60))
